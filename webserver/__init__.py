...
serverly.static_page(file_paths["repo"] +
                     "webserver/src/hello_world.html", "/helloworld")
serverly.static_page(
    file_paths["repo"] + "webserver/src/error_template.html", "/error")
serverly.static_page(file_paths["repo"] +
                     "webserver/src/welcome.html", "/")
serverly.static_page(file_paths["repo"] +
                     "webserver/src/register.html", "/register")
serverly.static_page(file_paths["repo"] + "webserver/src/login.html", "/login")
serverly.static_page(file_paths["repo"] +
                     "webserver/src/dashboard.html", "/dashboard")
serverly.static_page(file_paths["repo"] +
                     "webserver/src/account.html", "/account")
serverly.static_page(
    file_paths["repo"] + "webserver/src/user_successfully_verified.html", "/verified")


def start(hostname, port):
    serverly.stater.setup("mithem", "migpasswort123", "helix")
    serverly.address = (hostname, port)
